                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Edit Jenis Tunjangan: {{ $allowanceType->name }}
                        </h3>
                    ...
                    <form action="{{ route('allowance-types.update', $allowanceType) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $allowanceType->name) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('default_amount', $allowanceType->default_amount) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('calculation_type') is-invalid @enderror"
                                            ...
                                            <option value="per_hari"
                                                {{ old('calculation_type', $allowanceType->calculation_type) == 'per_hari' ? 'selected' : '' }}>
                                                Per Hari</option>
                                            <option value="per_bulan"
                                                {{ old('calculation_type', $allowanceType->calculation_type) == 'per_bulan' ? 'selected' : '' }}>
                                                Per Bulan</option>
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="3" placeholder="Deskripsi jenis tunjangan (opsional)">{{ old('description', $allowanceType->description) }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0 mt-2">
                                            <li>Perubahan jumlah default hanya akan mempengaruhi tunjangan baru yang
                                                ditambahkan</li>
                                            <li>Tunjangan yang sudah ada pada guru tidak akan berubah secara otomatis</li>
                                            <li>Jika ingin mengubah tunjangan yang sudah ada, edit secara manual di menu
                                                Tunjangan Guru</li>
                                        </ul>
                                    </div>
                                </div>
