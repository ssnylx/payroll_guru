    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header d-flex align-items-center border-bottom pb-2 bg-warning text-dark">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $subject->name) }}" required autofocus>
                                        @error('name')
