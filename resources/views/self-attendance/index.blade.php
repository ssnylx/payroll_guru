            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div class="position-relative d-inline-block">
                        <video id="video" class="img-fluid rounded border"
                        ...
                        <div id="camera-overlay"
                            class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-light rounded"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-md-none">
                    ...
                    <div
                        class="card mb-2 border-start border-3 {{ $attendance->status == 'hadir' ? 'border-success' : ($attendance->status == 'terlambat' ? 'border-warning' : 'border-danger') }}">
                        <div class="card-body py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-1">{{ $attendance->tanggal->format('d M Y') }}</h6>
                                    <small class="text-muted">{{ $attendance->jam_masuk ?? '-' }} -
                                        {{ $attendance->jam_keluar ?? '-' }}</small>
                                </div>
                                <div>
